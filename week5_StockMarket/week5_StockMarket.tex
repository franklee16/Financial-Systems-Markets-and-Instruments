...
\end{center}
\note{\href{https://sites.google.com/a/bc.edu/vyveslav-fos/home/proxy-contests}{sites.google.com/.../proxy-contests} (Vyacheslav Fos's proxy contests page).}
\end{frame}
...
\end{center}
\note{\href{https://www.sec.gov/Archives/edgar/data/1326801/000119312512034517/d287954ds1.htm}{SEC EDGAR filing (Meta 2012 S-1)}}
\end{frame}
...
\end{itemize}
\note{DMM: \href{https://www.nyse.com/market-model}{nyse.com/market-model}; \href{https://www.nyse.com/publicdocs/nyse/listing/fact_sheet_dmm.pdf}{nyse.com DMM fact sheet} (underscores escaped for LaTeX)}
\end{frame}
